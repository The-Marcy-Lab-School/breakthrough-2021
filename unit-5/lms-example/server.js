...
app.post('/students', async (req, res) => {
  try {
    await db.none('insert into students (full_name, email) values (${full_name}, ${email})', req.body)
...
app.patch('/students/:studentId', async (req, res) => {
  ...
  try {
    await db.none('update students set full_name=$1, email=$2 where id = $3', [req.body.name, req.body.email, studentId])
